...
%     - pick exactly one of `apacite`, `chem`, or none for custom citation style
%     - ...and probably more.

% Examples:
\documentclass[dissertation, final, draftcopy, apacite, copyright]{uothesis} % For final copies
